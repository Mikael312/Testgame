...
-- Variables already declared at top (unwalkEnabled, savedAnims, unwalkWatcher)
...
local function onAnimAdded(desc)
    if unwalkEnabled and isWalkAnim(desc) then
        saveAndClear(desc)
    end
end
...
local function startUnwalk()
    ...
    task.spawn(function()
        ...
        unwalkWatcher = char.DescendantAdded:Connect(onAnimAdded)
    end)
