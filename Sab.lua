--[[
    ...
    UPDATED: Added Server section with Job ID input, Join Server, Server Hop, and Rejoin Server buttons.
...
local function startAntiRagdoll()
    ...
    if humanoidWatchConnection then humanoidWatchConnection:Disconnect() humanoidWatchConnection = nil
...
-- Join Server Button (FIXED: 2 SAAT TIMEOUT)
...
-- Rejoin Server Button (FIXED: 2 SAAT TIMEOUT)
...
print("✅ ADDED: Server section with Job ID input, Join Server, Server Hop, and Rejoin Server buttons.")
