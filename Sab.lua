...
-- MAIN TAB (5 TOGGLES - Added Xray Base, Invisible V1, and Respawn Desync)
tabContent["Main"] = {}
...
print("🔧 Functions Added: ESP Players (FIXED), Aimbot (Laser Cape), Esp Turret (Sentry), Anti Debuff (Combined Anti Bee & Boogie), Base Line, Platform, Xray Base, Esp Best, Esp Base Timer (FIXED), Grapple Speed, Anti Knockback (NEW), Anti Ragdoll (NEW), Invisible V1 (NEW), Anti Trap (NEW), Respawn Desync (NEW)")
print("🆕 Added Toggles: Esp Best, Esp Base Timer, Base Line, Platform, Xray Base, Grapple Speed, Anti Knockback, Anti Ragdoll, Invisible V1, Anti Trap, Respawn Desync")
